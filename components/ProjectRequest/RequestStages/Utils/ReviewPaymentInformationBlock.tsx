		...
		<div className="flex w-full grow flex-col gap-2">
			...
			<div className="flex w-full grow flex-col gap-2">
				...
				<div className="my-1 flex w-full flex-col">
					<p className="w-full text-center text-sm font-light tracking-tighter text-primary/70">Escolha a metodologia de pagamento aplicável à esse projeto.</p>
					<p className="w-full text-center text-sm font-light tracking-tighter text-primary/70">
						Lembrando que valores de fracionamento são meras aproximações.
					</p>
				</div>
