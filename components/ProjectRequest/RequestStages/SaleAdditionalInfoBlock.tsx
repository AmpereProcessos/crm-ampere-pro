		...
		<div className="flex w-full flex-col gap-2">
			...
			<div className="flex w-full grow flex-col gap-2">
				...
				<div className="mt-2 flex w-full flex-col">
					<h1 className="w-full rounded-tl-sm rounded-tr-sm bg-primary/50 p-1 text-center font-bold text-primary-foreground">OBSERVAÇÕES SOBRE O PROJETO</h1>
					<textarea
				...
				<div className="mt-2 flex w-full flex-col">
					<h1 className="w-full rounded-tl-sm rounded-tr-sm bg-primary/50 p-1 text-center font-bold text-primary-foreground">OBSERVAÇÕES PARA O CONTATO</h1>
					<textarea
