...
import OpportunityLossReasonsBlock from "../Personalization/OpportunityLossReasonsBlock";
      ...
      <div className="flex w-full items-center justify-between border-b border-primary/30 pb-2">
        <div className="flex flex-col">
          ...
          <p className="text-sm text-[#71717A]">
            Gerencie e configure as equipamentos, credores, etc.
          </p>
        </div>
      </div>
      <div className="flex w-full flex-col gap-2 py-2">
        <OpportunityLossReasonsBlock session={session} />
