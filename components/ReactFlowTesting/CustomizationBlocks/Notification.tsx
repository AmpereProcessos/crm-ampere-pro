	...
	return (
		<div draggable={false} className="flex w-full flex-col gap-2">
			<div className="flex items-end gap-2">
				...
				<button
					draggable={false}
					onClick={() => vinculateResponsible({ userId: newResponsibleHolder, users: users || [], previousResponsibles: data.entidade.customizacao.destinatarios })}
			...
			<div className="flex w-full flex-col rounded-md border border-gray-300 p-2 shadow-md">
				...
				<input
					...
					onChange={(e) => updateNodeData(id, { ...data, entidade: { ...data.entidade, customizacao: { ...data.entidade.customizacao, mensagem: e.target.value } } })}
					type="text"
