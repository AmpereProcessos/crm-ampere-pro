...
function PurchasesFilterMenu({ updateFilters, selectedPartners, setSelectedPartners, partnersOptions, session, queryLoading, resetSelectedPage }: PurchasesFilterMenuProps) {
