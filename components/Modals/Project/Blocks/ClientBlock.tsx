        ...
        <div className='grid grid-cols-1 grid-rows-3 items-center gap-6 px-2 lg:grid-cols-3 lg:grid-rows-1'>
          ...
          <SelectInput
            ...
            handleChange={(value) => {
              ...
              setChanges((prev) => ({
                ...prev,
                client: { ...prev.client, uf: value, cidade: stateCities[value as keyof typeof stateCities][0] as string },
              }));
            }}
            resetOptionLabel='NÃO DEFINIDO'
            onReset={() => {
          ...
          <SelectInput
            ...
            options={
              infoHolder.clienteDados.uf
                ? stateCities[infoHolder.clienteDados.uf as keyof typeof stateCities].map((city, index) => ({
                    id: index + 1,
                    value: city,
                    label: city,
                  }))
