...
function EntityReferencesBlock({ project }: EntityReferencesBlockProps) {
  return (
    <div className="flex w-full flex-col flex-wrap items-center justify-center gap-2 p-2 lg:flex-row lg:gap-4">
      <div className="flex w-full flex-col rounded border border-cyan-800 lg:w-[450px]">
        ...
        <div className="flex w-full items-center justify-center gap-1">
          <BsCode />
          <p className="text-xs font-medium tracking-tight text-gray-500">#{project.cliente.id}</p>
        </div>
      </div>
      <div className="flex w-full flex-col rounded border border-cyan-800 lg:w-[450px]">
        <div className="flex w-full items-center justify-center gap-2 bg-cyan-800 p-2 text-white">
        ...
        <div className="flex w-full items-center justify-center gap-1">
          <BsCode />
          <p className="text-xs font-medium tracking-tight text-gray-500">#{project.oportunidade.id}</p>
        </div>
      </div>
      <div className="flex w-full flex-col rounded border border-cyan-800 lg:w-[450px]">
        <div className="flex w-full items-center justify-center gap-2 bg-cyan-800 p-2 text-white">
        ...
        <div className="flex w-full items-center justify-center gap-1">
          <BsCode />
          <p className="text-xs font-medium tracking-tight text-gray-500">#{project.proposta.id}</p>
        </div>
      </div>
    </div>
  )
