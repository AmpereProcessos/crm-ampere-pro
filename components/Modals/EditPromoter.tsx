    ...
    <div id='defaultModal' className='fixed bottom-0 left-0 right-0 top-0 z-100 bg-[rgba(0,0,0,.85)]'>
      <div className='fixed left-[50%] top-[50%] z-100 h-[80%] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-md bg-background p-[10px] xl:w-[60%]'>
        <div className='flex h-full flex-col'>
          ...
          <div className='flex h-full flex-col items-center gap-y-2 overflow-y-auto overscroll-y-auto py-4 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30'>
            ...
            {activeSaleGoalId ? (
              <button onClick={clearGoalsHolder} className='text-2xl text-primary/70 duration-300 ease-in-out hover:text-primary/40'>
                <AiOutlineClear />
              </button>
            ) : null}
            ...
            <div className='flex w-full items-center justify-end  px-2 py-2'>
              {activeSaleGoalId ? (
                <button
                  ...
                  className='rounded p-1 font-medium text-[#15599a] duration-300 ease-in-out disabled:text-primary/30 hover:scale-110 hover:bg-blue-50'
                >
                  SALVAR
                </button>
              ) : (
                <button
                  ...
                  className='rounded p-1 font-medium text-green-500 duration-300 ease-in-out disabled:text-primary/30 hover:scale-110 hover:bg-blue-50'
                >
                  CRIAR
                </button>
              )}
