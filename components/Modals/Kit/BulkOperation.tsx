...
import { getDateFromLocaleString, getModulesPeakPotByProducts } from '@/lib/methods/extracting';
...
import { KitsBulkOperationItemSchema, TKit, TKitDTO, TProductItem, TServiceItem } from '@/utils/schemas/kits.schema';
      ...
      const kits: (TKit & { _id: string | null; excluir: boolean })[] = bulkOperationKits.map((bulkKit) => {
        ...
        const definedPartner =
          bulkKit['VISIBILIDADE DE PARCEIRO'] != 'N/A'
            ? partners?.find((p) => p.nome == bulkKit['VISIBILIDADE DE PARCEIRO'])?._id || userPartnerId
            : null;
