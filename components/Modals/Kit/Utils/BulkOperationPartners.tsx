	...
	return (
		<AnimatePresence>
			<div className="flex w-full flex-col gap-2">
				...
				{blockIsOpen ? (
					<motion.div key={"block-open"} variants={GeneralVisibleHiddenExitMotionVariants} initial="hidden" animate="visible" exit="exit" className="flex w-full flex-col gap-2 p-2">
						<p className="text-sm tracking-tight text-gray-500">
							A coluna <strong className="text-[#E25E3E]">VISIBILIDADE DE PARCEIRO</strong> será referência para a restrição de visibilidade de parceiros do kit.
						</p>
						<p className="text-sm tracking-tight text-gray-500">
