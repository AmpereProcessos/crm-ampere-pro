...
function TransportationInformationBlock({ infoHolder, setInfoHolder }: TransportationInformationBlockProps) {
  return (
    <div className="flex w-full flex-col gap-y-2">
      <h1 className="w-full bg-gray-700 p-1 text-center font-medium text-white">INFORMAÇÕES DO FRETE</h1>
        ...
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          <div className="w-full lg:w-1/3">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({ ...prev, transporte: { ...prev.transporte, transportadora: { ...prev.transporte.transportadora, nome: value } } }))
              }
              width="100%"
            />
          </div>
