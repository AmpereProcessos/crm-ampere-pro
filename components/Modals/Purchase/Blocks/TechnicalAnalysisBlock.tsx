  ...
  return (
    <div className="flex w-full flex-col gap-y-2">
      ...
      <div className="flex w-full grow flex-wrap justify-around gap-2">
        {!analysisId ? (
          <p className="w-full text-center text-xs font-medium italic text-gray-500">Não há análise técnica disponível.</p>
        ) : (
          <div className="flex w-full items-center justify-center py-2">
            <div className="w-fit">
              <CheckboxInput labelFalse="MOSTRAR INFORMAÇÕES" labelTrue="MOSTRAR INFORMAÇÕES" checked={showInfo} handleChange={(value) => setShowInfo(value)} />
            </div>
          </div>
        )}
      </div>
