...
function DeliveryInformationBlock({ infoHolder, setInfoHolder }: DeliveryInformationBlockProps) {
  ...
  return (
    <div className='flex w-full flex-col gap-y-2'>
      <h1 className='w-full bg-primary/70  p-1 text-center font-medium text-primary-foreground'>INFORMAÇÕES DE ENTREGA</h1>
        ...
        <div className='flex w-full flex-col items-center gap-2 lg:flex-row'>
          ...
          <div className='w-full lg:w-1/3'>
            <DateInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({ ...prev, entrega: { ...prev.entrega, efetivacao: formatDateOnInputChange(value) } }))
              }
              width='100%'
            />
          </div>
