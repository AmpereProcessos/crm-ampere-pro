			...
			<div className="fixed left-[50%] top-[50%] z-[100] h-[80%] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-md bg-[#fff] p-[10px] lg:w-[70%]">
				<div className="flex h-full flex-col">
					...
					<div className="flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto px-2 py-1 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
						...
						{isSuccess ? (
							<>
								<GeneralInformationBlock infoHolder={infoHolder as TPurchaseDTO} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TPurchaseDTO>>} />
								...
								<CompositionInformationBlock infoHolder={infoHolder as TPurchaseDTO} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TPurchaseDTO>>} />
								<OrderInformationBlock infoHolder={infoHolder as TPurchaseDTO} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TPurchaseDTO>>} />
								<TransportationInformationBlock infoHolder={infoHolder as TPurchaseDTO} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TPurchaseDTO>>} />
								<BillingInformationBlock infoHolder={infoHolder as TPurchaseDTO} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TPurchaseDTO>>} />
								<DeliveryInformationBlock infoHolder={infoHolder as TPurchaseDTO} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TPurchaseDTO>>} />
