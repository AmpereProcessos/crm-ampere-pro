...
function ExpenseFileAttachmentMenu({ expenseId, revenueId, projectId, clientId, opportunityId, analysisId, homologationId, purchaseId, session }: ExpenseFileAttachmentMenuProps) {
	...
	async function handleFileReferenceCreation() {
		try {
			...
			const vinculationId = attachmentHolder.idExpense || attachmentHolder.idProject || attachmentHolder.idOpportunity || attachmentHolder.idClient || "naodefinido";
