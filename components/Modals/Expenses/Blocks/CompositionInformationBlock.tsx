...
import { TExpense, TExpenseCompositionItem } from '@/utils/schemas/expenses.schema'
import { Units } from '@/utils/select-options'
import React, { useState } from 'react'
import toast from 'react-hot-toast'
import ExpenseCompositionTable from './Utils/CompositionTable'
...
function CompositionInformationBlock({ infoHolder, setInfoHolder }: CompositionInformationBlockProps) {
  const [compositionItem, setCompositionItem] = useState<TExpenseCompositionItem>({
  ...
  function addItem(item: TExpenseCompositionItem) {
  ...
  return (
    <div className="flex w-full flex-col gap-y-2">
      <h1 className="w-full bg-gray-700  p-1 text-center font-medium text-white">COMPOSIÇÃO DA DESPESA</h1>
      <div className="flex w-full flex-col gap-1">
        ...
        <ExpenseCompositionTable infoHolder={infoHolder} setInfoHolder={setInfoHolder} />
        ...
        <div className="flex w-full items-end justify-center">
          <NumberInput
            ...
            placeholder="Preencha o valor total da despesa..."
