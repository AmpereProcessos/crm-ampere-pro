      ...
      <div className="my-2 flex w-full flex-wrap items-center gap-2">
        {infoHolder.categorias.length > 0 ? (
          infoHolder.categorias.map((category, index) => (
            <div className="group flex items-center gap-2 rounded border border-blue-800 px-4 py-2 shadow-sm">
        ...
        <div className="flex w-full items-end gap-2">
          ...
          <div className="w-fit">
            <button
              ...
              className="rounded-md bg-black p-3 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700"
            >
              ADICIONAR
            </button>
          </div>
