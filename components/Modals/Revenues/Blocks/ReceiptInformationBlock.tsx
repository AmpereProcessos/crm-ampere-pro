...
function RevenueReceiptInformationBlock({ infoHolder, setInfoHolder }: RevenueReceiptInformationBlockProps) {
	...
	return (
		<div className="flex w-full flex-col gap-y-2">
			<h1 className="w-full bg-gray-700  p-1 text-center font-medium text-white">INFORMAÇÕES DE RECEBIMENTO</h1>
			<div className="flex w-full flex-col gap-1">
				...
				<div className="flex w-full flex-col gap-2">
					...
					<div className="flex items-center justify-end">
						<button className="rounded bg-black p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700" onClick={() => addReceipt(receiptHolder)}>
