            ...
            <div className='flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto px-2 py-1 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30'>
              ...
              <div className='flex w-full items-center justify-between gap-2'>
                <SelectInput
                  ...
                  onReset={() =>
                    setQueryParams((prev) => ({ ...prev, firstPeriodAfter: initialFirstPeriodAfter, firstPeriodBefore: initialFirstPeriodBefore }))
                  }
                />
                <SelectInput
                  ...
                  resetOptionLabel='NÃO DEFINIDO'
                  onReset={() =>
                    setQueryParams((prev) => ({ ...prev, secondPeriodAfter: initialSecondPeriodAfter, firstPeriodBefore: initialSecondPeriodBefore }))
                  }
                />
              </div>
