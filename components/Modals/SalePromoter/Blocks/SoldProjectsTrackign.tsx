...
type ProjectsSoldTrackingProps = {
...
function ProjectsSoldTracking({ data, firstPeriodAfter, firstPeriodBefore, secondPeriodAfter, secondPeriodBefore }: ProjectsSoldTrackingProps) {
  const chartData = mergePeriodsData(data.primeiro.projetosVendidos.mensal, data.segundo.projetosVendidos.mensal)
  const chartConfig = {
    mes: {
      label: 'Mês',
      color: '#000000',
    ...
    valorPrimeiro: {
      label: 'Projetos Vendidos do Primeiro Período',
      color: '#15599a',
    },
    valorSegundo: {
      label: 'Projetos Vendidos do Segundo Período',
      color: '#fead41',
    },
...
export default ProjectsSoldTracking
