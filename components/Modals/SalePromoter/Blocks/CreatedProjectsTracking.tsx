...
import { TSalePromoterResultsById } from '@/pages/api/stats/comercial-results/sellers'
...
type CreatedProjectsTrackingProps = {
...
function CreatedProjectsTracking({ data, firstPeriodAfter, firstPeriodBefore, secondPeriodAfter, secondPeriodBefore }: CreatedProjectsTrackingProps) {
  const chartData = mergePeriodsData(data.primeiro.projetosCriados.mensal, data.segundo.projetosCriados.mensal)
  const chartConfig = {
    mes: {
      label: 'Mês',
      color: '#000000',
    ...
    valorPrimeiro: {
      label: 'Projetos Criados do Primeiro Período',
      color: '#15599a',
    },
    valorSegundo: {
      label: 'Projetos Criados do Segundo Período',
      color: '#fead41',
    },
...
export default CreatedProjectsTracking
