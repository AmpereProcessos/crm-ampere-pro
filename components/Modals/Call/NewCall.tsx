			...
			<div className="fixed left-[50%] top-[50%] z-[100] h-[90%] w-[60%] translate-x-[-50%] translate-y-[-50%] rounded-md bg-[#fff] p-[10px]">
				<div className="flex h-full flex-col">
					...
					<div className="flex grow flex-col overflow-y-auto overscroll-y-auto py-4 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
						...
						<div className="mt-1 flex w-full flex-col items-center gap-2 lg:flex-row">
							...
							<div className="w-full lg:w-[50%]">
								<DropdownSelect
									...
									categoryName="CIDADE"
									value={infoHolder.cliente.cidade && infoHolder.cliente.uf ? stateCities[infoHolder.cliente.uf as keyof typeof stateCities].indexOf(infoHolder.cliente.cidade) : null}
									options={
						...
						{infoHolder.tipoSolicitacao == "ANÁLISE DE CRÉDITO" ? <AttachFile files={files} setFiles={setFiles} clientIdentifier={infoHolder.cliente.cpfCnpj || ""} /> : null}
					</div>
