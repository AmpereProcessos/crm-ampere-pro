...
import { editPaymentMethod } from '@/utils/mutations/payment-methods';
              ...
              <div className='flex h-full grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto p-2 py-1 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30'>
                <div className='my-5 flex flex-col'>
                  ...
                  <p className='text-primary/50'>
                    ...
                    capaz de <strong className='text-[#E25E3E]'>personalizar</strong> os métodos de pagamento que compõe a sua proposta.
                  </p>
                </div>
