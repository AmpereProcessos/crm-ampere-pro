				...
				{isSuccess ? (
					<>
						<div className="flex-1 overflow-auto">
							<UseDataContent userId={userId} session={session} userInfo={userInfo} updateUserInfo={updateUserInfo} avatarFile={avatarFile} updateAvatarFile={updateAvatarFile} />
						</div>
						<DialogFooter>
							<DialogClose asChild>
	...
	return (
		<div className="w-full h-full flex flex-col gap-6">
			<div className="my-2 flex w-full items-center justify-center">
				<div className="w-fit">
					<CheckboxInput labelFalse="USUÁRIO ATIVO" labelTrue="USUÁRIO ATIVO" checked={userInfo.ativo} handleChange={(value) => updateUserInfo({ ativo: value })} />
				</div>
			</div>
					...
					handleChange={(value) => {
						...
						const permissions: TUser["permissoes"] = {
							...
							oportunidades: {
								...
								excluir: session.user.permissoes.oportunidades.excluir ? group.permissoes.oportunidades.excluir : session.user.permissoes.oportunidades.excluir,
							},
							analisesTecnicas: {
								escopo: [userId], // refere-se ao escopo de atuação
							...
							configuracoes: {
								...
								gruposUsuarios: session.user.permissoes.configuracoes.gruposUsuarios ? group.permissoes.configuracoes.gruposUsuarios : session.user.permissoes.configuracoes.gruposUsuarios,
							},
							integracoes: {
