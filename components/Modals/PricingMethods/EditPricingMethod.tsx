...
function EditPricingMethod({ pricingMethodId, session, closeModal }: EditPricingMethodProps) {
  ...
  const {
    ...
    isSuccess,
    isError,
  } = usePricingMethodById({ id: pricingMethodId });
  ...
  useEffect(() => {
    if (pricingMethod) actions.setAll(pricingMethod);
  }, [pricingMethod, actions]);
            ...
            <div className="flex h-full grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto p-2 py-1 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30">
              <div className="my-5 flex flex-col">
                ...
                <p className="text-primary/70">
                  ...
                  criação de fórmulas de{" "}
                  <strong className="text-[#15599a]">cálculo de custo.</strong>
                </p>
              </div>
              <TextInput
              ...
              <div className="flex w-full flex-col items-end gap-1">
                ...
                <button
                  ...
                  className="h-9 whitespace-nowrap rounded-sm bg-blue-800 px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm disabled:cursor-not-allowed disabled:bg-primary/40 disabled:text-primary-foreground/70 enabled:hover:bg-blue-800"
