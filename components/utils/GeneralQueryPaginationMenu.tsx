...
function GeneralQueryPaginationMenu({ activePage, selectPage, totalPages, itemsMatched, itemsShowing, queryLoading }: GeneralQueryPaginationMenuProps) {
	return (
			...
			{totalPages > 1 ? (
				<>
					<p className="w-full text-center text-sm leading-none tracking-tight text-gray-500">
						Um número grande de itens foi encontrado, separamos em páginas para facilitar a visualização. Clique na página desejada para visualizar os demais itens.
					</p>
