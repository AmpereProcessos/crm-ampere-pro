		...
		<div className="flex w-full flex-col gap-y-2">
			...
			{newDocumentMenuIsOpen ? (
				...
				<div className="flex w-full items-center justify-end">
					<button className="rounded bg-green-500 p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-green-600" onClick={() => setNewDocumentMenuIsOpen(true)}>
						NOVO DOCUMENTO
					</button>
				</div>
			)}
