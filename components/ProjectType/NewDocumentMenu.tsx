	...
	return (
		<div className="flex w-[80%] flex-col gap-2 self-center rounded-md border border-gray-500 p-2 font-Inter">
			...
			<div className="my-2 flex items-center justify-end gap-2">
				<button onClick={() => addDocument(newDocumentationHolder)} className="rounded bg-blue-600 p-1 px-4 text-xs font-medium text-white duration-300 ease-in-out hover:bg-blue-800">
					CADASTRAR DOCUMENTO
				</button>
			</div>
		</div>
