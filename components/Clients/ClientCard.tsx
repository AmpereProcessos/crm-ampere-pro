...
import { Pencil, Send, Share2, UserRound } from "lucide-react";
		...
		<div className="flex w-full flex-col rounded-md border border-primary/50 bg-background p-4 gap-2 sm:flex-row">
			<div className="flex items-center justify-center">
				<div className="relative h-20 max-h-20 min-h-20 w-20 max-w-20 min-w-20 overflow-hidden rounded-lg">
					{client.conecta?.avatar_url ? (
						<Image src={client.conecta?.avatar_url} alt={client.nome} fill={true} objectFit="cover" />
					) : (
