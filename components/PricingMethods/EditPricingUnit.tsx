...
import { conditionsAlias, formatCondition, formatConditionValue, formatFormulaItem, getConditionOptions, renderConditionPhrase, variablesAlias } from "@/utils/pricing/helpers";
...
function EditPricingUnit({ index, pricingHolder, setPricingHolder, resultHolder, setResultHolder, methodology, setMethodology, partners, closeMenu }: EditPricingUnitProps) {
	...
	return (
        ...
        <div className="flex w-full flex-col">
          ...
          />
			...
			<div className="my-2 flex items-center justify-end gap-2">
				<button className="rounded bg-blue-600 p-1 px-4 text-xs font-medium text-white duration-300 ease-in-out hover:bg-blue-800" onClick={() => createPricingUnit()}>
