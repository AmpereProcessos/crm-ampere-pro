				...
				<div className="flex w-full flex-col gap-2 lg:flex-row">
					<div className="w-full lg:w-1/2">
						<NumberInput
							...
							value={resultHolder.condicao.entre?.minimo != null && resultHolder.condicao.entre?.minimo != undefined ? Number(resultHolder.condicao.entre?.minimo) : null}
							handleChange={(value) =>
								setResultHolder((prev) => ({
									...prev,
					...
					<div className="w-full lg:w-1/2">
						<NumberInput
							...
							value={resultHolder.condicao.entre?.maximo != null && resultHolder.condicao.entre?.maximo != undefined ? Number(resultHolder.condicao.entre?.maximo) : null}
							handleChange={(value) =>
								setResultHolder((prev) => ({
									...prev,
