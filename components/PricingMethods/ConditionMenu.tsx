    ...
    <div className='flex w-full flex-col'>
      ...
      {resultHolder.condicao.tipo == 'IGUAL_TEXTO' ? (
        <SelectInput
          ...
          options={getConditionOptions({
            variable: resultHolder.condicao.variavel as keyof TPricingConditionData,
            additional: { partners: partners || [] },
          })}
      ...
      {resultHolder.condicao.tipo == 'MAIOR_QUE_NÚMERICO' ? (
        <NumberInput
          ...
          placeholder='Preencha o valor para comparação.'
          value={
            resultHolder.condicao.maiorQue != null && resultHolder.condicao.maiorQue != undefined ? Number(resultHolder.condicao.maiorQue) : null
          }
      ...
      {resultHolder.condicao.tipo == 'MENOR_QUE_NÚMERICO' ? (
        <NumberInput
          ...
          placeholder='Preencha o valor para comparação.'
          value={
            resultHolder.condicao.menorQue != null && resultHolder.condicao.menorQue != undefined ? Number(resultHolder.condicao.menorQue) : null
          }
            ...
            <NumberInput
              ...
              handleChange={(value) =>
                setResultHolder((prev) => ({
                  ...
                  condicao: {
                    ...prev.condicao,
                    entre: prev.condicao.entre ? { ...prev.condicao.entre, minimo: value } : { minimo: value, maximo: 0 },
                  },
                }))
              }
              width='100%'
            ...
            <NumberInput
              ...
              handleChange={(value) =>
                setResultHolder((prev) => ({
                  ...
                  condicao: {
                    ...prev.condicao,
                    entre: prev.condicao.entre ? { ...prev.condicao.entre, maximo: value } : { minimo: 0, maximo: value },
                  },
                }))
              }
              width='100%'
