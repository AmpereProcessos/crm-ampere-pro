...
function ProcessFlowReferences({ flowReferences }: ProcessFlowReferencesProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-2 rounded border border-gray-800">
      <h1 className="w-full rounded bg-gray-800 p-1 text-center font-bold text-white">FLUXO DE PROCESSOS</h1>
      <p className="w-full text-center text-sm tracking-tight">Visualize o fluxo de processos do projeto.</p>
      <div className="flex h-[700px] w-full flex-col rounded border border-gray-500 p-2">
