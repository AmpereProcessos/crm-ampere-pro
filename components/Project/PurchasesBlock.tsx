...
function PurchasesBlock({ project, session }: PurchasesBlockProps) {
  ...
  return (
    <div className='flex w-full flex-col gap-2 rounded-sm border border-primary/80'>
      <h1 className='w-full rounded-sm bg-primary/80 p-1 text-center font-bold text-white'>COMPRAS</h1>
      <div className='flex w-full grow flex-col gap-2 p-2'>
        {isLoading ? <h1 className='w-full animate-pulse text-center font-medium text-primary/50'>Buscando registros de compra</h1> : null}
