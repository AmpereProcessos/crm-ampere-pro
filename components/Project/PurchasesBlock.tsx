...
function PurchasesBlock({ project, session }: PurchasesBlockProps) {
	...
	return (
		<div className="flex w-full flex-col gap-2 rounded border border-gray-800">
			<h1 className="w-full rounded bg-gray-800 p-1 text-center font-bold text-white">COMPRAS</h1>
			<div className="flex w-full grow flex-col gap-2 p-2">
				{isLoading ? <h1 className="w-full animate-pulse text-center font-medium text-gray-500">Buscando registros de compra</h1> : null}
