...
function Partner({ partner, goToNextStage }: PartnerProps) {
	...
	return (
		<div className="flex h-full w-full flex-col gap-y-2">
			...
			<h1 className="mb-4 w-full text-center text-lg tracking-tight text-gray-500">Passaremos por algumas etapas para configurar informações da empresa e de outros detalhes.</h1>
