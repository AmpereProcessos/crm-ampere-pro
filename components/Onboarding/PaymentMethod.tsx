	...
	return (
		<div className="flex grow flex-col gap-y-2">
			<h1 className="mt-4 w-full px-2 text-center text-lg tracking-tight text-gray-500">
				Cada parceiro tem métodos e necessidades diferentes para as suas metodologias de pagamento. Sendo assim, oferecemos uma maneira para que você personalize os métodos de
				pagamento a ser oferecidos nas propostas comerciais.
			</h1>
			...
			<h1 className="mb-4 w-full px-2 text-center text-lg tracking-tight text-gray-500">Se desejar, você pode pular essa etapa e criar seus métodos de pagamento posteriormente.</h1>
