	...
	return (
		<div className="flex grow flex-col gap-y-2">
			<h1 className="mt-4 w-full text-center text-lg tracking-tight text-gray-500">
				Nós possibilitamos que você defina suas metodologias de precificação. Essas podem ser vinculadas aos kits que você eventualmente criar, de modo que as proposta geradas
				utilizando-os sejam precificadas com a metodologia que você definiu.
			</h1>
			<h1 className="mb-4 w-full text-center text-lg tracking-tight text-gray-500">Se desejar, você pode pular essa etapa e definir suas metodologias posteriormente.</h1>
			...
			<div className="my-5 flex flex-col px-2">
				...
				<p className="text-gray-500">
					...
					<strong className="text-[#E25E3E]">condições</strong> , e tenha flexibilidade na criação de fórmulas de <strong className="text-[#E25E3E]">cálculo de custo.</strong>
				</p>
			</div>
			...
			{newPriceUnitMenuIsOpen ? (
				...
				<div className="flex w-full items-center justify-end px-2">
					<button className="rounded bg-green-500 p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-green-600" onClick={() => setNewPriceUnitMenuIsOpen(true)}>
			...
			{methodology.itens.length > 0 ? (
				methodology.itens.map((item, index) => (
					<div key={index} className="flex w-full flex-col rounded-md border border-gray-500 p-3 shadow-md">
