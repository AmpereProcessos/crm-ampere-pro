				...
				<div className="flex w-full flex-col items-center justify-between gap-4 border-b border-black pb-2 lg:flex-row lg:items-end">
					...
					<div className="flex h-9 items-center gap-2 rounded-lg bg-gray-300 px-1 py-2 lg:px-3">
						<button
							...
							className={`${
								mode == "process-tracking" ? "bg-white text-black shadow-md" : "bg-transparent text-gray-500 hover:bg-gray-200"
						...
						<button
							...
							className={`${
								mode == "projects-follow-up" ? "bg-white text-black shadow-md" : "bg-transparent text-gray-500 hover:bg-gray-200"
