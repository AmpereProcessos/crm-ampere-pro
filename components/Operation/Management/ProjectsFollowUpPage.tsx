        ...
        <>
          <div className='mb-4 flex w-full flex-col items-center justify-between gap-2 lg:flex-row'>
            <div className='flex min-w-fit flex-col items-center'>
              ...
              <p className='text-xs tracking-tight text-primary/70'>{projects.length} projetos encontrados...</p>
            </div>
          ...
          <div className='flex w-full flex-col gap-6'>
            {projects.map((project, key) => (
              ...
              //             <h1 className="text-sm tracking-tight text-primary/70 duration-300 ease-in-out hover:text-cyan-500">{project.identificador}</h1>
              //           </Link>
              //         ) : (
              //           <h1 className="text-sm tracking-tight text-primary/70">{project.identificador}</h1>
              //         )}
              //       </div>
              //     </div>
