        ...
        <>
          <div className='mb-4 flex w-full flex-col items-center justify-between gap-2 lg:flex-row'>
            <div className='flex min-w-fit flex-col items-center'>
              <h1 className='text-center text-lg font-black tracking-tighter'>FOLLOW UP DE PROJETOS</h1>
              <p className='text-xs tracking-tight text-primary/50'>{projects.length} projetos encontrados...</p>
            </div>
          ...
          <div className='flex w-full flex-col gap-6'>
            {projects.map((project, key) => (
              ...
              // <div key={key} className="flex w-full flex-col gap-2 rounded-sm border border-primary/50 bg-background p-4 shadow-md">
              ...
              //             <h1 className="text-sm tracking-tight text-primary/50 duration-300 ease-in-out hover:text-cyan-500">{project.identificador}</h1>
              //           </Link>
              //         ) : (
              //           <h1 className="text-sm tracking-tight text-primary/50">{project.identificador}</h1>
              //         )}
              //       </div>
              //     </div>
