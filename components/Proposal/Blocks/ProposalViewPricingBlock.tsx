      ...
      {userHasPricingViewPermission ? (
        <>
            ...
            <div className='flex w-full flex-col rounded-md bg-background py-2'>
                  ...
                  >
                    ...
                    <div className='flex w-2/12 flex-col items-center justify-center p-1'>
                      ...
                      <div className='flex items-center gap-1'>
                        ...
                        <h1 className='text-[0.65rem] text-primary/50'>{formatToMoney(custoFinal)}</h1>
                      </div>
                    </div>
                    <div className='flex w-2/12 flex-col items-center justify-center p-1'>
                      ...
                      <div className='flex items-center gap-1'>
                        <TbMathFunction color={'rgb(6,182,212)'} />
                        <h1 className='text-[0.65rem] text-primary/50'>{formatToMoney(valorCalculado * calculatedProfitMargin)}</h1>
                      </div>
                    </div>
                    <div className='flex w-2/12 flex-col items-center justify-center p-1'>
                      ...
                      <div className='flex items-center gap-1'>
                        <TbMathFunction color={'rgb(6,182,212)'} />
                        <h1 className='text-[0.65rem] text-primary/50'>{formatToMoney(valorCalculado)}</h1>
                      </div>
                    </div>
                  </div>
                );
              ...
              <div className='flex w-full items-center rounded-sm border-t border-primary/30 py-1'>
                ...
                <div className='flex w-2/12 flex-col items-center justify-center p-1'>
                  ...
                  <div className='flex items-center gap-1'>
                    <TbMathFunction color={'rgb(6,182,212)'} />
                    <h1 className='text-[0.65rem] text-primary/50'>{formatToMoney(getPricingTotals(pricing).costCalculated)}</h1>
                  </div>
                </div>
                <div className='flex w-2/12 flex-col items-center justify-center p-1'>
                  ...
                  <div className='flex items-center gap-1'>
                    <TbMathFunction color={'rgb(6,182,212)'} />
                    <h1 className='text-[0.65rem] text-primary/50'>{formatToMoney(getPricingTotals(pricing).profitCalculated)}</h1>
                  </div>
                </div>
                <div className='flex w-2/12 flex-col items-center justify-center p-1'>
                  ...
                  <div className='flex items-center gap-1'>
                    <TbMathFunction color={'rgb(6,182,212)'} />
                    <h1 className='text-[0.65rem] text-primary/50'>{formatToMoney(getPricingTotals(pricing).totalCalculated)}</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='mt-2 flex w-full flex-col gap-1 rounded-sm border border-primary/50 shadow-md lg:hidden'>
            <h1 className='rounded-tl-md rounded-tr-md bg-primary/50 p-2 text-center font-Raleway font-bold text-white'>ITENS</h1>
            {pricing.map((priceItem, index) => {
              if (pricing) {
            ...
            <h1 className='mt-4 bg-primary/80 p-2 text-center font-Raleway font-bold text-white'>TOTAIS</h1>
