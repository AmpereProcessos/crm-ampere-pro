...
function Kits({ infoHolder, setInfoHolder }: KitsProps) {
	return (
		<div className="flex w-full flex-col items-center gap-2">
			<h1 className="w-full rounded-sm bg-[#fead41] p-2 text-center font-bold leading-none tracking-tighter">KITS</h1>
			<div className="flex w-full flex-col gap-1">
				{infoHolder.kits.length > 0 ? (
					...
					<p className="w-full text-center text-sm italic text-primary/70">Nenhum kit vinculado à proposta...</p>
				)}
			</div>
		</div>
	);
