...
import { FaIndustry, FaInstagram, FaPhone } from 'react-icons/fa';
      ...
      <div className='flex w-full grow flex-col'>
        ...
        <div className='flex w-full flex-col gap-1'>
          {proposal.produtos.map((product, index) => (
            <div key={`${product.categoria}-${product.fabricante}-${product.modelo}`} className='flex w-full flex-col border border-primary/50 p-2'>
