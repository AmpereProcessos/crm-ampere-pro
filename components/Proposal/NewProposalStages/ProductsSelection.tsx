...
function ProductsSelection({ opportunity, infoHolder, setInfoHolder, moveToNextStage, moveToPreviousStage, setApplicablePaymentMethodsIds, session }: ProductsSelectionProps) {
					...
					{isSuccess ? (
						products.length > 0 ? (
							...
							<div className="flex flex-col items-center justify-center gap-4">
								...
								<p className="flex w-full items-center justify-center py-2 text-center font-medium italic tracking-tight text-gray-500">Nenhum produto encontrado.</p>
							</div>
						)
					) : null}
				</div>
