...
function PlansSelection({ opportunity, signaturePlans, infoHolder, plansLoading, plansError, setInfoHolder, moveToNextStage, moveToPreviousStage, session }: PlansSelectionProps) {
	...
	return (
		<div className="flex min-h-[400px] w-full flex-col gap-2 py-4">
			<div className="flex w-full items-center justify-center">
				<h1 className="text-center font-medium italic text-[#fead61]">Nessa etapa por favor escolha as opções de planos que deseja contemplar na sua proposta.</h1>
			</div>
					...
					signaturePlans.length > 0 ? (
						...
						<div className="flex flex-col items-center justify-center gap-4">
							...
							<p className="w-full text-center text-sm italic text-gray-600 lg:w-[50%]">
								Oops, parece que não há planos cadastrados considerados os filtros que você selecionou. Contate o setor responsável ou, se desejar, busque os demais kits clicando em{" "}
								<strong className="text-[#15599a]">"Mostrar todos os kits"</strong>.
							</p>
						</div>
					)
				) : null}
