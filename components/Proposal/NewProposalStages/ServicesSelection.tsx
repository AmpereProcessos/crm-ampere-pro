...
function ServicesSelection({ opportunity, infoHolder, setInfoHolder, moveToNextStage, moveToPreviousStage, setApplicablePaymentMethodsIds, session }: ServicesSelectionProps) {
	...
	return (
		<div className="flex min-h-[400px] w-full flex-col gap-2 py-4">
			<div className="flex w-full items-center justify-center">
				<h1 className="text-center font-medium italic text-[#fead61]">Nessa etapa por favor escolha os serviços que melhor se adequem as necessidades desse projeto.</h1>
			</div>
					...
					{isSuccess ? (
						services.length > 0 ? (
							...
							<div className="flex flex-col items-center justify-center gap-4">
								...
								<p className="flex w-full items-center justify-center py-2 text-center font-medium italic tracking-tight text-gray-500">Nenhum serviço encontrado.</p>
							</div>
						)
					) : null}
				</div>
