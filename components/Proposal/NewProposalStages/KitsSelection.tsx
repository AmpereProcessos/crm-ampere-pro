...
import { getModulesQty } from "@/utils/methods/solar";
import { useKitQueryPipelines } from "@/utils/methods/queries";
				...
				<div className="flex w-full flex-col items-center justify-between gap-1 lg:flex-row">
					...
					<div className="flex flex-col-reverse items-center gap-1 lg:flex-row lg:gap-2">
						...
						<div className="flex items-center gap-1 rounded-lg bg-cyan-500 px-2 py-1 lg:py-2">
							...
							<h1 className="text-[0.7rem] font-black text-primary-foreground">{formatDecimalPlaces(getSelectedKitsTotalPower(selectedKits), 2)} kWp</h1>
						</div>
					</div>
				</div>
