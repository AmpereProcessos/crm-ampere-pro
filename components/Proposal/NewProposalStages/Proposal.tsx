...
function renderProposalPreview({
  ...
  if (opportunity.categoriaVenda == 'PRODUTOS')
    return <ProposalWithProductsTemplate proposal={proposal} opportunity={opportunity} partner={partner} />;
  if (opportunity.categoriaVenda == 'SERVIÇOS')
    return <ProposalWithServicesTemplate proposal={proposal} opportunity={opportunity} partner={partner} />;
}
