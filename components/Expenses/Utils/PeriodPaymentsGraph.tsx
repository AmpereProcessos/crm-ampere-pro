...
type PeriodPaymentsGraphProps = {
	dailyData: TExpenseStatsResults["diario"];
};
function PeriodPaymentsGraph({ dailyData }: PeriodPaymentsGraphProps) {
	...
	return (
		<div className="flex w-full flex-col rounded-md border border-primary/50 bg-background shadow-md">
			<div className="flex items-center justify-between p-4 text-primary">
				<h1 className="text-sm font-medium uppercase tracking-tight">FLUXO DE PAGAMENTOS</h1>
				<BsBarChartFill />
			</div>
...
export default PeriodPaymentsGraph;
