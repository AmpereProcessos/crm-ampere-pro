...
function ActivationBlock(node: TProcessFlowReferenceNode) {
  ...
  return (
    <div className='flex w-full flex-col gap-2 rounded-sm border border-primary/50'>
      <h1 className='w-full rounded-sm bg-primary/80 p-1 text-center text-xs font-bold text-white'>CONFIGURAÇÃO DE ATIVAÇÃO</h1>
      <div className='flex w-full flex-col gap-2 p-2'>
        <p className='w-full text-center text-[0.65rem] text-primary/50'>
