...
function DocumentFileInput({ label, value, handleChange, fileReferences, multiple = false }: DocumentFileInputProps) {
  ...
  return (
    <div ref={ref} className='relative flex w-full flex-col justify-center self-center'>
      ...
      {showMenu ? (
        <div className='absolute top-[95px] z-100 flex h-[250px] max-h-[250px] w-full flex-col gap-2 self-center overflow-y-auto overscroll-y-auto rounded-md border border-primary/30 bg-background p-2 py-1 shadow-md scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30'>
