            ...
            {items ? (
              items.map((item, index) => (
                <button
                  ...
                  className={`flex w-full cursor-pointer items-center rounded-sm p-1 px-2 hover:bg-primary/20 ${selectedId === item.id ? 'bg-primary/20' : ''}`}
                >
                  <p className='grow text-start text-sm font-medium text-primary'>{item.label}</p>
