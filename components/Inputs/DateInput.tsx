	...
	return (
		<div className={`flex w-full flex-col gap-1 lg:w-[${width ? width : "350px"}]`}>
			...
			<input
				...
				type="date"
				className={cn(
					"w-full rounded-md border border-primary/20 p-3 text-sm shadow-sm outline-none duration-500 ease-in-out dark:bg-[#121212] placeholder:italic focus:border-primary",
					holderClassName,
				)}
			/>
		</div>
