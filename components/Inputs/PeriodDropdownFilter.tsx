...
function PeriodDropdownFilter({ initialAfter, initialBefore, setDateParam }: PeriodDropdownFilterProps) {
  ...
  return (
    <div ref={ref} className='relative flex h-[46.6px] w-[46.6px] justify-end'>
      ...
      {dropdownIsOpen ? (
        <div className='absolute -right-[400%] top-[45px] z-100 flex h-[115px] w-[350px] flex-col self-center rounded-md border border-primary/30 bg-background p-2 shadow-md'>
          ...
          <div className='mt-2 flex w-full items-center justify-between'>
            <div className='flex flex-col items-start'>
              ...
              <input
                ...
                className='text-xs text-primary/70 outline-hidden'
                onChange={(e) =>
                  setDateFilter((prev) => ({
                    ...prev,
