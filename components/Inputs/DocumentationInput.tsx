          ...
          <div className='flex w-full items-center justify-center lg:justify-end'>
            {showReferencesMenu ? (
              <button
                ...
                className='flex items-center gap-1 rounded-sm border border-red-500 bg-red-50 px-2 py-1 text-red-500 duration-300 ease-in-out hover:bg-red-100'
              >
              ...
              <button
                ...
                className='flex items-center gap-1 rounded-sm border border-blue-500 bg-blue-50 px-2 py-1 text-blue-500 duration-300 ease-in-out hover:bg-blue-100'
              >
