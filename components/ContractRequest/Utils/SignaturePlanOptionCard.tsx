...
function SignaturePlanOptionCard({ activePlanName, plan, proposal, opportunity, handleSelect }: SignaturePlanOptionCardProps) {
	...
	return (
		<div className="flex min-h-[250px] w-full gap-2 rounded-md border border-gray-300 shadow-md lg:w-[800px]">
			<div className="flex w-full grow flex-col p-3">
				<div className="flex w-full grow flex-col">
					<div className="flex w-full items-center justify-between gap-2">
						...
						{plan.nome == activePlanName ? <h1 className="rounded-full bg-green-600 px-2 py-1 text-[0.65rem] font-bold text-white lg:text-xs">SELECIONADO</h1> : null}
					</div>
