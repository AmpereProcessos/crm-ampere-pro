		...
		<div className="flex w-full flex-col bg-background pb-2 gap-6 grow">
			<div className="w-full flex flex-col gap-2">
				...
				<h1 className="w-full text-center font-medium tracking-tight">
					Se existirem arquivos vinculados ao projeto, você pode utilizá-los clicando em <strong className="text-blue-800">MOSTRAR OPÇÕES</strong> e escolhendo
					o arquivo desejado.
				</h1>
			</div>
		...
		<div className="w-full flex flex-col gap-2">
			<div className="flex w-full items-center justify-end gap-2">
				<button
					...
					className={cn("flex items-center gap-1 rounded-lg px-2 py-1 text-primary duration-300 ease-in-out", {
						"bg-primary/30  hover:bg-red-300": newAttachmentFileMenuIsOpen,
			...
			<div className="w-full flex flex-col gap-3">
				{otherAttachments.map((f) => (
					<div key={`attachment-${f.title}`} className="flex w-full justify-between items-center gap-1 rounded-sm border border-primary bg-background p-2">
			...
			<div className="flex w-full flex-col gap-2 p-3">
				<div className="relative flex w-full items-center justify-center">
					<label
						...
						className="flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-primary/20 bg-background hover:bg-primary/10"
					>
