    ...
    <div className="flex w-full flex-col bg-background pb-2 gap-6 grow">
      ...
      <div className="w-full flex flex-col grow gap-4">
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="w-full flex flex-col gap-1">
            <p className="text-sm tracking-tight font-medium text-start w-fit">
              Define explicitamente abaixo sobre a inclusão, no escopo da venda, de uma nova
              estrutura ou de adequação de estrutura existente.
            </p>
            <div className="w-full flex items-center justify-center gap-2 flex-wrap">
              <Button
                variant={requestInfo.estruturaAmpere === "NÃO" ? "default" : "ghost"}
              ...
              <Button
                variant={requestInfo.estruturaAmpere === "SIM" ? "default" : "ghost"}
          ...
          {requestInfo.estruturaAmpere === "SIM" ? (
            <>
              ...
              <div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded-sm w-fit">
                <ChevronRight size={15} />
                <h1 className="text-xs tracking-tight font-medium text-start w-fit">
                  INFORMAÇÕES DE PAGAMENTO DA ESTRUTURA
                </h1>
              </div>
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="w-full flex flex-col gap-1">
            <p className="text-sm tracking-tight font-medium text-start w-fit">
              Define explicitamente abaixo sobre a inclusão, no escopo da venda, de troca de padrão
              ou aumento de carga.
            </p>
            <div className="w-full flex items-center justify-center gap-2 flex-wrap">
              <Button
                variant={requestInfo.aumentoDeCarga === "NÃO" ? "default" : "ghost"}
              ...
              <Button
                variant={requestInfo.aumentoDeCarga === "SIM" ? "default" : "ghost"}
          ...
          {requestInfo.aumentoDeCarga === "SIM" ? (
            <>
              ...
              <div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded-sm w-fit">
                <ChevronRight size={15} />
                <h1 className="text-xs tracking-tight font-medium text-start w-fit">
                  INFORMAÇÕES DE PAGAMENTO DO PADRÃO
                </h1>
              </div>
              <div className="w-full flex items-center gap-2 flex-col lg:flex-row">
                <div className="w-full lg:w-1/2">
