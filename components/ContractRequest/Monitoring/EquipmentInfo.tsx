		...
		<div className="flex w-full grow flex-col  bg-[#fff] pb-2">
			...
			<div className="flex w-full grow flex-col gap-1">
				...
				<div className="flex items-center justify-end">
					<button className="rounded bg-black p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700" onClick={() => addToList(equipmentHolder)}>
