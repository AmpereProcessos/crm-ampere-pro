			...
			<div className="flex w-full flex-col gap-1">
				<div className="flex w-full flex-col gap-1">
					...
					<div className="flex items-center justify-end">
						<button className="rounded bg-black p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700" onClick={() => addInverterToKit()}>
							ADICIONAR INVERSOR
						</button>
					</div>
				</div>
				<div className="flex w-full flex-col gap-1">
					...
					<div className="flex items-center justify-end">
						<button className="rounded bg-black p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700" onClick={() => addModuleToKit()}>
							ADICIONAR MÓDULO
						</button>
					</div>
				</div>
				<div className="flex w-full flex-col gap-1">
					...
					<div className="flex items-center justify-end">
						<button className="rounded bg-black p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700" onClick={() => addPersonalizedProductToKit()}>
