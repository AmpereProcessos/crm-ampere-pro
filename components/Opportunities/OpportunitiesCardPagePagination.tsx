...
type OpportunitiesCardPagePaginationProps = {
  activePage: number
  totalPages: number
  opportunitiesMatched?: number
  opportunitiesShowing?: number
  selectPage: (page: number) => void
  queryLoading: boolean
}
function OpportunitiesCardPagePagination({
  activePage,
  totalPages,
  opportunitiesMatched,
  opportunitiesShowing,
  selectPage,
  queryLoading,
}: OpportunitiesCardPagePaginationProps) {
  return (
      ...
      <p className="w-full text-center text-sm leading-none tracking-tight text-gray-500">
        {opportunitiesShowing != null
          ? opportunitiesShowing > 0
            ...
            : `Mostrando ${opportunitiesShowing} oportunidade.`
          : '...'}
      </p>
    </div>
  )
...
export default OpportunitiesCardPagePagination
