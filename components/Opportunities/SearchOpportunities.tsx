...
function OpportunityCard({ opportunity }: { opportunity: TOpportunitySimplifiedDTO }) {
  ...
  return (
    <div key={opportunity._id} className="flex w-full flex-col gap-1 rounded border border-primary bg-[#fff] p-2 shadow-sm">
      ...
      <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
        ...
        <div className="flex w-full flex-wrap items-center justify-center gap-2 lg:min-w-fit lg:justify-end">
          <Link href={`/comercial/oportunidades/id/${opportunity._id}`}>
            <p className="rounded-lg bg-black px-2 py-1 text-[0.55rem] tracking-tight text-white duration-300 ease-in-out hover:bg-gray-800">
              VER OPORTUNIDADE
            </p>
          </Link>
        </div>
