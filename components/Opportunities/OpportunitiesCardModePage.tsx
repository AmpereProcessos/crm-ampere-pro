...
function OpportunitiesCardModePage({
  session,
  partnersOptions,
  responsiblesOptions,
  projectTypesOptions,
  funnelsOptions,
  handleSetMode,
}: OpportunitiesCardModePageProps) {
  ...
  const { data, isLoading, isError, isSuccess, updateFilters } = useOpportunitiesByPersonalizedFilters({
    page,
    responsibles,
    partners,
    projectTypes,
