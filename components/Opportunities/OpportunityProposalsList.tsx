...
function ProposalListBlock({
	...
	return (
		<div className="flex h-[250px] w-full flex-col rounded-md border border-gray-300 bg-[#fff] p-3 shadow-lg">
			...
			<div className="overscroll-y flex w-full grow flex-col gap-1 overflow-y-auto py-1 pr-2 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
				...
				{opportunityProposalsSuccess ? (
					opportunityProposals.length > 0 ? (
						...
						<p className="flex w-full grow items-center justify-center py-2 text-center font-medium italic tracking-tight text-gray-500">Sem propostas vinculadas a essa oportunidade.</p>
					)
				) : null}
			</div>
		</div>
	...
	// return (
	//   <div className="flex h-[300px] w-full flex-col rounded-md border border-gray-300 bg-[#fff] p-3 shadow-lg lg:w-[60%]">
	//     <div className="flex  h-[40px] items-center  justify-between border-b border-gray-300 pb-2">
	//       <div className="flex items-center justify-center gap-5">
