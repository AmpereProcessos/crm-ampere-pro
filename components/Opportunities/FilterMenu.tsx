        ...
        <div className='flex w-full flex-col flex-wrap items-center justify-start gap-2 lg:flex-row'>
          ...
          <div className='flex w-full flex-col items-center gap-2 lg:w-fit lg:flex-row'>
            <div className='flex w-full flex-col gap-1 lg:w-fit'>
              <h1 className='text-xs font-medium tracking-tight text-primary'>PERÍODO</h1>
            ...
            <SelectInput
              ...
              resetOptionLabel='CAMPO NÃO DEFINIDO'
          ...
          <div className='w-full md:w-[350px]'>
            <MultipleSelectInputVirtualized
              label='RESPONSÁVEIS'
              options={
                responsibleSelectableOptions?.map((promoter) => ({ id: promoter._id || '', label: promoter.nome, value: promoter._id })) || null
              }
