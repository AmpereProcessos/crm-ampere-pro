...
function TechnicalAnalysisKit({ kit, selectedId, userHasPricingViewPermission, handleClick }: KitCardProps) {
	return (
		<div className="flex min-h-[250px] w-full gap-2 rounded-md border border-gray-300 bg-[#fff] font-Inter shadow-md">
				...
				<div className="flex w-full grow flex-col">
					...
					<div className="flex w-full flex-col flex-wrap gap-2 lg:flex-row">
						{kit.produtos.map((product, index) => (
							<div key={index} className="mt-1 flex w-full flex-col rounded-md border border-gray-300 p-2 lg:w-[400px]">
					...
					<div className="flex w-full flex-col flex-wrap gap-2 lg:flex-row">
						{kit.servicos.map((service, index) => (
							<div key={index} className="mt-1 flex flex-col rounded-md border border-gray-300 p-2">
								<div className="flex w-full items-center justify-between gap-2">
									<div className="flex  items-center gap-1">
