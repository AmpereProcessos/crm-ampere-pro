...
import { FaIndustry, FaSolarPanel, FaTag } from "react-icons/fa";
...
function Kit({ kit, handleClick, userHasEditPermission, userHasPricingViewPermission }: KitCardProps) {
	return (
		<div className="flex min-h-[250px] w-full gap-2 rounded-md border border-gray-500 bg-[#fff] font-Inter shadow-md lg:w-[600px]">
				...
				<div className="flex w-full items-center justify-between gap-2">
					<div className="flex items-center gap-1">
						...
						{userHasEditPermission ? (
							<h1 onClick={() => handleClick(kit)} className="cursor-pointer text-sm font-black leading-none tracking-tight duration-300 ease-in-out hover:text-cyan-500">
								{kit.nome}
							</h1>
						) : (
