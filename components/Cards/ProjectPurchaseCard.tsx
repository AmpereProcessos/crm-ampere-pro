...
function getStatusTag(status?: string | null) {
	...
	if (status == "PENDÊNCIA COMERCIAL")
		return <h1 className={`w-fit self-center rounded-sm border border-green-800 p-1 text-center text-[0.6rem] font-black text-green-800`}>{status}</h1>;
	...
	if (status == "PENDÊNCIA EXTERNA")
		return <h1 className={`w-fit self-center rounded-sm border border-primary/80 p-1 text-center text-[0.6rem] font-black text-primary/80`}>{status}</h1>;
	...
	return <h1 className={`w-fit self-center rounded-sm border border-primary/50 p-1 text-center text-[0.6rem] font-black text-primary/70`}>NÃO DEFINIDO</h1>;
}
