...
function BulkOperationKit({ kit }: BulkOperationKitProps) {
  ...
  // return (
  //   <div className="flex w-full flex-col gap-2 border border-primary/50 bg-background p-4 font-Inter shadow-md">
  ...
  return (
    <div className='flex w-full gap-2 rounded-md border border-primary/50 bg-background font-Inter shadow-md lg:w-[600px]'>
