							...
							<div className="flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto py-2 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
								...
								{analysis.dataEfetivacao ? (
									<div className="flex w-full flex-col items-center gap-2">
										...
										<button onClick={reopenAnalysis} className="rounded border border-gray-500 p-1 font-bold text-gray-500 duration-300 ease-in-out hover:bg-gray-500 hover:text-white">
											REABRIR ANÁLISE
										</button>
									</div>
								) : (
									<div className="flex w-full flex-col items-center gap-2">
										...
										/>
										<button onClick={concludeVisita} className="rounded border border-green-500 p-1 font-bold text-green-500 duration-300 ease-in-out hover:bg-green-500 hover:text-white">
											FINALIZAR ANÁLISE
										</button>
									</div>
								)}
								<span className="mb-2 w-full rounded-tl-md rounded-tr-md bg-[#15599a] py-2 text-center font-bold text-white">INFORMAÇÕES DO CLIENTE</span>
								{analysis.projeto ? (
										...
										<div className="flex items-center gap-2">
											...
											{analysis.projeto.id ? (
												<Link href={`https://crm.ampereenergias.com.br/projeto/id/${analysis.projeto.id}`}>
													<a className="font-raleway cursor-pointer text-sm font-medium duration-300 ease-in-out hover:text-cyan-300">#{analysis.projeto.identificador || "N/A"}</a>
												</Link>
											) : (
												<p className="font-raleway cursor-pointer text-sm font-medium duration-300 ease-in-out hover:text-blue-300">#{analysis.projeto.identificador || "N/A"}</p>
											)}
										</div>
										<div className="flex items-center gap-2">
