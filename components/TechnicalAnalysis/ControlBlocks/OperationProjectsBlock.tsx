		...
		<div className="flex w-full flex-col gap-2">
			...
			{isSuccess ? (
				<div className="fle w-full grow flex-col gap-2">
					...
					<div className="flex max-h-[500px] w-full flex-col gap-1 overflow-y-auto overscroll-y-auto scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30">
						{operationProjects.length > 0 && !selectedProject
							? operationProjects?.map((project: any, index: number) => (
									<div key={project._id} className="flex w-full flex-col rounded-md border border-primary/30 p-3">
