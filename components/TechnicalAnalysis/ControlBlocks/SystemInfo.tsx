	...
	return (
		<div className="flex w-full grow flex-col bg-background px-2">
			...
			<div className="flex w-full grow flex-col gap-2">
				{proposal?.kit ? (
					<div className="flex w-full flex-col self-center rounded-sm border border-primary/30 p-3 shadow-md lg:w-[60%]">
					...
					{selectedKits.length > 0 ? (
						<>
							...
							<div className="flex w-full items-center justify-center gap-2">
								<div className="flex flex-col rounded-sm border border-[#15599a] p-2 text-[#15599a]">
				...
				<div className="mt-2 flex w-full flex-wrap items-center justify-between gap-1">
					...
					<div className="flex w-full items-end justify-center gap-2">
						...
						<button
							...
							className="flex h-[46px] w-full items-center justify-center rounded-sm border border-[#fead61] p-3 text-[#fead61] hover:bg-[#fead61] hover:text-primary lg:w-fit"
						>
							<AiOutlineSearch />
						</button>
					</div>
				</div>
				<div className="flex max-h-[500px] grow flex-wrap items-center justify-center gap-2 overflow-y-auto overscroll-y-auto p-2 py-1 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30 lg:justify-between">
