...
function TransformerInfo({ requestInfo, setRequestInfo, requireFiles = true, files, setFiles, goToNextStage, goToPreviousStage }: TransformerInfoProps) {
								...
								<div className="absolute">
									{files?.fotoNumeroTrafo ? (
										<div className="flex flex-col items-center">
											<i className="fa fa-folder-open fa-4x text-blue-700"></i>
											<span className="block text-center font-normal text-primary/40">
												{typeof files.fotoNumeroTrafo.file != "string" ? files.fotoNumeroTrafo.file?.name : formatLongString(files.fotoNumeroTrafo.file, 35)}
											</span>
										</div>
									) : (
										<div className="flex flex-col items-center">
