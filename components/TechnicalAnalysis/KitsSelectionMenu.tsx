...
function KitsSelectionMenu({ selectedKitId, handleSelect, session, closeMenu }: KitsSelectionMenuProps) {
	...
	return (
		<AnimatePresence>
			<motion.div variants={GeneralVisibleHiddenExitMotionVariants} initial="hidden" animate="visible" exit="exit" className="flex w-full flex-col gap-1 border border-gray-500 p-2">
