    ...
    <div className='h-[29.7cm] w-[21cm]'>
      <div className='flex h-full w-full flex-col'>
        ...
        <div className='mt-6 flex flex-col'>
          ...
          <div className='flex w-full flex-col'>
            <div className='grid grid-cols-10 border border-black'>
              <div className='col-span-1 flex items-center justify-center border-r border-black bg-primary/30 text-center text-xs font-bold'>
                NºCAIXA
              </div>
              <div className='col-span-2 flex items-center justify-center border-r border-black bg-primary/30 text-center text-xs font-bold'>
                AMPERAGEM
              </div>
              <div className='col-span-2 flex items-center justify-center border-r border-black bg-primary/30 text-center text-xs font-bold'>
                MONO/BI/TRI
        ...
        <div className='mt-6 flex flex-col'>
          ...
          <div className='flex border border-t-0 border-black'>
            <div className='flex w-[30%] items-center justify-center border-r border-black bg-primary/30 text-center text-xs font-bold'>
              TIPO DA TELHA
            </div>
          ...
          <div className='flex border border-t-0 border-black'>
            <h1 className='flex w-[30%] items-center justify-center border-r border-black bg-primary/30 text-center text-xs font-bold'>
              TIPO DE EDIFICAÇÃO
            </h1>
