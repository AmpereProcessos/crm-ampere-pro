			...
			<div className="mt-2 flex w-full flex-col items-center justify-around gap-2 lg:flex-row">
				<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-primary/30 bg-background p-6 shadow-md lg:w-1/6">
					...
					<div className="mt-2 flex w-full flex-col">
						...
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosCriados.inbound || 0} INBOUND</p>
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosCriados.outboundVendedor} OUTBOUND (VENDEDOR)</p>
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosCriados.outboundSdr} OUTBOUND (SDR)</p>
					</div>
				</div>
				<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-primary/30 bg-background p-6 shadow-md lg:w-1/6">
					<div className="flex items-center justify-between">
					...
					<div className="mt-2 flex w-full flex-col">
						...
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosGanhos.inbound} INBOUND</p>
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosGanhos.outboundVendedor} OUTBOUND (VENDEDOR)</p>
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosGanhos.outboundSdr} OUTBOUND (SDR)</p>
					</div>
				</div>
				<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-primary/30 bg-background p-6 shadow-md lg:w-1/6">
					<div className="flex items-center justify-between">
					...
					<div className="mt-2 flex w-full flex-col">
						...
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosPerdidos.inbound} INBOUND</p>
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosPerdidos.outboundVendedor} OUTBOUND (VENDEDOR)</p>
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.projetosPerdidos.outboundSdr} OUTBOUND (SDR)</p>
					</div>
				</div>
				<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-primary/30 bg-background p-6 shadow-md lg:w-1/6">
					<div className="flex items-center justify-between">
					...
					<div className="mt-2 flex w-full flex-col">
						...
						<p className="text-[0.65rem] font-medium text-primary/80">{stats?.totalVendido.inbound ? formatToMoney(stats?.totalVendido.inbound) : 0} INBOUND</p>
					...
					<div className="mt-2 flex w-full flex-col">
						...
						<p className="text-[0.65rem] font-medium text-primary/80">
							{stats?.conversao.ganho.outboundVendedor
								? formatDecimalPlaces((stats?.conversao.ganho.outboundVendedor * 100) / stats?.conversao.criado.outboundVendedor)
								: 0}
							% OUTBOUND (VENDEDOR)
						</p>
						<p className="text-[0.65rem] font-medium text-primary/80">
							{stats?.conversao.ganho.outboundSdr ? formatDecimalPlaces((stats?.conversao.ganho.outboundSdr * 100) / stats?.conversao.criado.outboundSdr) : 0}%
							OUTBOUND (SDR)
						</p>
					</div>
				</div>
			</div>
			<CreditorsResults after={after} before={before} responsibles={responsibles} partners={partners} projectTypes={projectTypes} />
