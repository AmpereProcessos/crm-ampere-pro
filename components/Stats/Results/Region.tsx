	...
	return (
		<div className="flex w-full flex-col">
			...
			<div className="flex w-full flex-col gap-2 rounded-xl border border-primary/30 bg-background p-6 shadow-md">
				...
				<div className="flex max-h-[700px] w-full flex-col gap-2 overflow-y-auto overscroll-y-auto px-2 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30">
						...
						<div key={`${stat.CIDADE}-${index}`} className="w-full flex flex-col">
							...
							<div className="hidden w-full items-center gap-2 rounded-sm border border-primary/30 p-2 lg:flex">
								...
								<div className="flex w-1/5 flex-col items-center justify-center">
									<h1 className="text-sm font-black text-primary/70">{stat["OPORTUNIDADES CRIADAS"].INBOUND + stat["OPORTUNIDADES CRIADAS"].OUTBOUND}</h1>
								...
								<div className="flex w-1/5 flex-col items-center justify-center">
									<h1 className="text-sm font-black text-primary/70">{stat["OPORTUNIDADES GANHAS"].INBOUND + stat["OPORTUNIDADES GANHAS"].OUTBOUND}</h1>
									<div className="flex w-full items-center justify-center gap-2">
										<div className="flex items-center gap-1">
											<h1 className="text-[0.6rem] font-light">INBOUND</h1>
								...
								<div className="flex w-1/5 flex-col items-center justify-center">
									<h1 className="text-sm font-black text-primary/70">{stat["OPORTUNIDADES PERDIDAS"].INBOUND + stat["OPORTUNIDADES PERDIDAS"].OUTBOUND}</h1>
									<div className="flex w-full items-center justify-center gap-2">
										<div className="flex items-center gap-1">
											<h1 className="text-[0.6rem] font-light">INBOUND</h1>
								...
								<div className="flex w-1/5 flex-col items-center justify-center">
									<h1 className="text-sm font-black text-primary/70">{formatToMoney(stat["VALOR VENDIDO"].INBOUND + stat["VALOR VENDIDO"].OUTBOUND)}</h1>
									<div className="flex w-full items-center justify-center gap-2">
										<div className="flex items-center gap-1">
											<h1 className="text-[0.6rem] font-light">INBOUND</h1>
							...
							{/** MOBILE */}
							<div className="flex w-full flex-col items-center gap-2 rounded-sm border border-primary/50 p-2 lg:hidden">
