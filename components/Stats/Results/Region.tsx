      ...
      <div className="flex w-full flex-col gap-2 rounded-xl border border-gray-200 bg-[#fff] p-6 shadow-sm">
        ...
        <div className="flex max-h-[700px] w-full flex-col gap-2 overflow-y-auto overscroll-y-auto px-2 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
          {stats?.map((stat, index) => (
            <>
              {/** WEB */}
              <div key={index} className="hidden w-full items-center gap-2 rounded border border-gray-300 p-2 lg:flex">
                <div className="flex w-1/5 items-center justify-center">
              ...
              {/** MOBILE */}
              <div key={index} className="flex w-full flex-col items-center gap-2 rounded border border-gray-500 p-2 lg:hidden">
                ...
                <div className="flex w-full flex-wrap items-center justify-center gap-2">
                  <div className="flex w-fit flex-col items-center justify-center rounded border border-gray-300 p-2">
                    ...
                    <h1 className="text-[0.65rem] font-black text-gray-500">
