	...
	return (
		<div className="flex w-full flex-col">
			...
			<div className="mt-2 flex w-full flex-col items-start gap-2 lg:flex-row">
				<SdrStatCard icon={<AiOutlineThunderbolt />} label="Potência Vendida" promoters={promoters || []} statKey="potenciaPico" stats={stats} statsLoading={!stats} />
			...
			<div className="mt-2 flex w-full flex-col items-start gap-2 lg:flex-row">
				...
				<SdrStatCard icon={<MdAttachMoney />} label="Projetos criados" promoters={promoters || []} statKey="projetosCriados" stats={stats} statsLoading={!stats} />
			</div>
			<div className="mt-2 flex w-full flex-col items-start gap-2 lg:flex-row">
