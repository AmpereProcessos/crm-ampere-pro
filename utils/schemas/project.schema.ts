...
export const ProjectSchema = z.object({
  ...
  imagemCapaUrl: z
    .string({ invalid_type_error: "Tipo não válido para a URL da imagem de capa do projeto." })
    .optional()
    .nullable(),
  app: z.object({
    data: z
...
export type TAppProjectResultsSimplified = Pick<
  TProject,
  | "qtde"
  | "nomeDoContrato"
  | "codigoSVB"
