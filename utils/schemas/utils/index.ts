...
export const AcquisitionChannelSchema = z.object({
	...
	valor: z.string({ required_error: "Canal de aquisição não informado.", invalid_type_error: "Tipo não válido para o canal de aquisição." }),
	slug: z.string({ required_error: "Slug do canal de aquisição não informado.", invalid_type_error: "Tipo não válido para o slug do canal de aquisição." }),
	autor: AuthorSchema,
	dataInsercao: z
		.string({ required_error: "Data de inserção não informada.", invalid_type_error: "Tipo não válido para a data de inserção." })
		.datetime({ message: "Formato inválido para data de inserção." }),
