...
export const GeneralTechnicalAnalysisSchema = z.object({
	...
	pendencias: z.array(
		z.object({
			...
			dataFinalizacao: z
				.string({
					invalid_type_error: "Tipo inválido para data de finalização da pendência.",
				})
				.optional()
				.nullable(),
		...
		z.object({
			...
			novaAmperagem: z
				.union([z.string(), z.number()], {
					invalid_type_error: "Tipo não válido para a nova amperagem do padrão.",
				})
				.optional()
				.nullable(), // x
			novaLigacao: z
			...
			modeloCaixaMedidor: z
				.string({
					invalid_type_error: "Tipo não válido para o modelo da caixa do medidor.",
				})
				.optional()
				.nullable(),
			codigoPosteDerivacao: z
				.string({
					invalid_type_error: "Tipo não válido para o código do poste de derivação.",
				})
				.optional()
				.nullable(), // GO only
		}),
	...
	custos: z.array(
		z.object({
			...
			custoUnitario: z
				.number({
					invalid_type_error: "Tipo não válido para o custo unitário do item de custo.",
				})
				.optional()
				.nullable(),
			total: z
			...
			totalVendaSimples: z
				.number({
					invalid_type_error: "Tipo não válido para o total do item para venda simples.",
				})
				.optional()
				.nullable(),
			totalVendaFaturavel: z
				.number({
					invalid_type_error: "Tipo não válido para o total do item para venda faturável.",
				})
				.optional()
				.nullable(),
		}),
	...
	alocacaoModulos: z.object({
		leste: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para leste.",
			})
			.optional()
			.nullable(),
		nordeste: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para nordeste.",
			})
			.optional()
			.nullable(),
		noroeste: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para noroeste.",
			})
			.optional()
			.nullable(),
		norte: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para norte.",
			})
			.optional()
			.nullable(),
		oeste: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para oeste.",
			})
			.optional()
			.nullable(),
		sudeste: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para sudeste.",
			})
			.optional()
			.nullable(),
		sudoeste: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para sudoeste.",
			})
			.optional()
			.nullable(),
		sul: z
			.number({
				invalid_type_error: "Tipo não válido para quantidade alocada de modelo para sul.",
			})
			.optional()
			.nullable(),
	}),
	...
	dataEfetivacao: z
		.string({
			invalid_type_error: "Tipo não válido para a data de efetivação da análise técnica.",
		})
		.datetime({
