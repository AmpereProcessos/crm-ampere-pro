...
const GeneralStockMaterialSchema = z.object({
  ...
  nomeTecnico: z.string({ required_error: 'Nome técnico do material não informado.', invalid_type_error: 'Tipo não válido para o nome técnico do material.' }),
  ...
  qtdeMaxima: z
    ...
    .nullable(),
  unidade: UnitSchema,
  localizacao: z.string({ required_error: 'Localização do material não informada.', invalid_type_error: 'Tipo não válido para a localização do material.' }),
