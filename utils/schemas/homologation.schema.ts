...
const HomologationLocationSchema = z.object({
	...
	latitude: z
		.string({
			invalid_type_error: "Tipo não válido para latitude da localização da homologação.",
		})
		.optional()
		.nullable(),
	longitude: z
		.string({
			invalid_type_error: "Tipo não válido para longitude da localização da homologação.",
		})
		.optional()
		.nullable(),
...
const HomologationDocumentationSchema = z.object({
	...
	dataInicioElaboracao: z
		.string({
			invalid_type_error: "Tipo não válido para a data de início da elaboração da documentação.",
		})
		.datetime({
			message: "Formato inválido para a data de início da elaboração da documentação.",
		})
		.optional()
		.nullable(),
	...
	dataLiberacao: z
		.string({
			invalid_type_error: "Tipo não válido para a data de liberação das documentações.",
		})
		.datetime({
	...
	dataAssinatura: z
		.string({
			invalid_type_error: "Tipo não válido para a data de assinatura das documentações.",
		})
		.datetime({
...
const HomologationAccessControlSchema = z.object({
	...
	dataSolicitacao: z
		.string({
			invalid_type_error: "Tipo não válido para a data de solicitação de acesso.",
		})
		.datetime({
	...
	dataResposta: z
		.string({
			invalid_type_error: "Tipo não válido para a data de resposta da solicitação de acesso.",
		})
		.datetime({
			message: "Formato inválido para a data de resposta da solicitação de acesso.",
		})
		.optional()
		.nullable(),
});
...
const HomologationVistorySchema = z.object({
	dataSolicitacao: z
		.string({
			invalid_type_error: "Tipo não válido para a data de solicitação da vistoria.",
		})
		.datetime({
	...
	dataEfetivacao: z
		.string({
			invalid_type_error: "Tipo não válido para a data de execução da vistoria.",
		})
		.datetime({
