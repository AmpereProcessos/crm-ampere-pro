...
export const MonthGoalInformation = z.object({
  ...
  vendas: z.number({ required_error: 'Valor de meta de vendas não informado.', invalid_type_error: 'Tipo não válido para o valor de meta de vendas.' }),
})

export const SaleGoalSchema = z.object({
  ano: z.number({ required_error: 'Ano de referência da meta não informado.', invalid_type_error: 'Tipo não válido para o ano de referência da meta.' }),
  inicio: z.string({
    required_error: 'Início do mês de referência da meta não informado.',
    invalid_type_error: 'Tipo não válido para o início do mês de referência da meta.',
  }),
  ...
  dataInsercao: z.string({ required_error: 'Data de inserção da meta não informada.', invalid_type_error: 'Tipo não válido para data de inserção da meta.' }),
})
