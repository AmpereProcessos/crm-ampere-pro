...
export function getProjectTypeColor(projectType: string) {
	return ProjectTypeColors[projectType as keyof typeof ProjectTypeColors]?.combination || "bg-primary text-primary-foreground";
}
export const Months = [
	{
		id: 1,
