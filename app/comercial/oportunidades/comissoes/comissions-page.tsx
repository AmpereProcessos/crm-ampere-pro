					...
					{isSuccess ? (
						<>
							...
							<div className="w-full flex items-center justify-center gap-2 flex-wrap">
								<div className={cn("flex items-center gap-1 rounded-lg px-2 py-0.5 text-center text-xxs font-bold italic bg-green-100 text-green-700")}>
								...
								<div className={cn("flex items-center gap-1 rounded-lg px-2 py-0.5 text-center text-xxs font-bold italic bg-orange-100 text-orange-700")}>
									<BadgeCheck className={cn("w-4 h-4 min-w-4 min-h-4")} />
