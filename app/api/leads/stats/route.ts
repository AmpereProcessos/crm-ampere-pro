      ...
      },
      {
        $group: {
          ...
          contactsInPreviousPeriod: {
            $sum: {
              $cond: [
                { $and: [{ $gte: ['$dataUltimoContato', afterWithMarginDateStr] }, { $lt: ['$dataUltimoContato', beforeWithMarginDateStr] }] },
                1,
                0,
              ],
            },
          ...
          qualificationsInPreviousPeriod: {
            $sum: {
              $cond: [
                { $and: [{ $gte: ['$qualificacao.data', afterWithMarginDateStr] }, { $lt: ['$qualificacao.data', beforeWithMarginDateStr] }] },
                1,
                0,
              ],
            },
