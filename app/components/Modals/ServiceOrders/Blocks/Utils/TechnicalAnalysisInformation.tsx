...
import { TbAtom, TbBoxModel, TbPlugConnected } from 'react-icons/tb'
...
function TechnicalAnalysisInformation({ analysis }: TechnicalAnalysisInformationProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-y-2 py-2">
      <>
        <h1 className="w-full bg-gray-500 p-1 text-center text-xs font-medium text-white">DETALHES</h1>
        <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
          <div className="flex flex-col items-center gap-1 lg:items-start">
            <div className="flex items-center gap-1">
              <TbAtom size={12} />
              <p className="text-[0.65rem] font-medium text-gray-500">MATERIAL DA ESTRUTURA</p>
            </div>
          ...
          <div className="flex flex-col items-center gap-1 lg:items-end">
            <div className="flex items-center gap-1">
              ...
              <p className="text-[0.65rem] font-medium text-gray-500">TIPO DA ESTRUTURA</p>
            </div>
        ...
        <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
          <div className="flex flex-col items-center gap-1 lg:items-start">
            <div className="flex items-center gap-1">
              ...
              <p className="text-[0.65rem] font-medium text-gray-500">ORIENTAÇÃO</p>
            </div>
          ...
          <div className="flex flex-col items-center gap-1 lg:items-end">
            <div className="flex items-center gap-1">
              <RxSquare size={12} />
              <p className="text-[0.65rem] font-medium text-gray-500">TIPO DA TELHA</p>
            </div>
            <p className="text-[0.6rem] font-medium leading-none tracking-tight">{analysis.detalhes.tipoTelha || 'NÃO DEFINIDO'}</p>
          </div>
        </div>
        <h1 className="w-full bg-gray-500 p-1 text-center text-xs font-medium text-white">PADRÕES</h1>
        <div className="flex w-full flex-col gap-1">
          {analysis.padrao.map((info, index) => (
            <div key={index} className="flex w-full flex-col rounded border border-gray-500 p-3">
              ...
              <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
                <div className="flex flex-col items-center gap-1 lg:items-start">
                  <div className="flex items-center gap-1">
                    <MdDashboard size={12} />
                    <p className="text-[0.65rem] font-medium text-gray-500">TIPO</p>
                  </div>
                ...
                <div className="flex flex-col items-center gap-1 lg:items-end">
                  <div className="flex items-center gap-1">
                    ...
                    <p className="text-[0.65rem] font-medium text-gray-500">LIGAÇÃO</p>
                  </div>
              ...
              <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
                <div className="flex flex-col items-center gap-1 lg:items-start">
                  <div className="flex items-center gap-1">
                    ...
                    <p className="text-[0.65rem] font-medium text-gray-500">ENTRADA</p>
                  </div>
                ...
                <div className="flex flex-col items-center gap-1 lg:items-end">
                  <div className="flex items-center gap-1">
                    ...
                    <p className="text-[0.65rem] font-medium text-gray-500">SAÍDA</p>
                  </div>
                ...
                <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
                  <div className="flex flex-col items-center gap-1 lg:items-start">
                    <div className="flex items-center gap-1">
                      ...
                      <p className="text-[0.65rem] font-medium text-gray-500">NOVA AMPERAGEM</p>
                    </div>
                  ...
                  <div className="flex flex-col items-center gap-1 lg:items-end">
                    <div className="flex items-center gap-1">
                      <TbPlugConnected size={12} />
                      <p className="text-[0.65rem] font-medium text-gray-500">NOVA LIGAÇÃO</p>
                    </div>
        ...
        <h1 className="w-full bg-gray-500 p-1 text-center text-xs font-medium text-white">SUPRIMENTOS</h1>
        <div className="flex items-center gap-1">
          <MdSettingsInputComponent size={12} />
          <p className="text-[0.65rem] font-medium text-gray-500">ITENS DE INSUMO</p>
        </div>
        ...
        {analysis.execucao.memorial && analysis.execucao.memorial.length > 0 ? (
          ...
          <p className="w-full text-center text-sm font-medium tracking-tight text-gray-500">Nenhuma descritivo adicionado.</p>
        )}
      </>
    </div>
  )
