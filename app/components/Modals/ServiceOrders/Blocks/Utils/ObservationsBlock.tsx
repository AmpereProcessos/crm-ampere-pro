...
function ObservationsBlock({ infoHolder, setInfoHolder }: ObservationsBlockProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-y-2">
      <h1 className="w-full bg-gray-500 p-1 text-center text-xs font-medium text-white">OBSERVAÇÕES P/ EXECUÇÃO</h1>
      <div className="flex w-full flex-col gap-1">
        {infoHolder.observacoes.length > 0 ? (
          <div className="flex w-full flex-col gap-1">
            <h1 className="w-full text-start text-sm font-medium tracking-tight text-gray-500">
