		...
		<div className="flex w-full flex-col gap-y-2">
			...
			<div className="flex w-full flex-col gap-1">
				{infoHolder.responsaveis.length > 0 ? (
					<div className="flex w-full flex-col gap-1">
						<h1 className="w-full text-center text-sm font-medium tracking-tight text-gray-500 lg:text-start">Os responsáveis pela execução do serviço são:</h1>
						<div className="flex flex-wrap items-center justify-center gap-2 lg:gap-6">
							{infoHolder.responsaveis.map((responsible, index) => (
								<div
									...
									key={index}
									className="flex cursor-pointer items-center gap-2 rounded-xl border border-gray-500 px-2 py-0.5 text-gray-800 hover:border-red-500 lg:p-2"
								>
				...
				<div className="flex w-full flex-col gap-1">
					...
					<div className="flex flex-col items-center justify-end gap-4 lg:flex-row">
						...
						<button className="rounded bg-black p-1 px-4 text-sm font-medium text-white duration-300 ease-in-out hover:bg-gray-700" onClick={() => addResponsible(newResponsibleHolder)}>
