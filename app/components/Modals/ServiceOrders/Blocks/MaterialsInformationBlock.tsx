		...
		<div className="flex w-full flex-col gap-y-2">
			...
			<div className="flex w-full flex-col gap-2">
				...
				<div className="flex flex-col items-center justify-end gap-1 lg:flex-row lg:gap-4">
					<button className="rounded bg-[#fead41] p-1 px-4 text-xs font-medium text-white duration-300 ease-in-out hover:bg-yellow-400" onClick={() => addAsAvailable(materialHolder)}>
						ADICIONAR COMO DISPONÍVEL
					</button>
					<button className="rounded bg-[#15599a] p-1 px-4 text-xs font-medium text-white duration-300 ease-in-out hover:bg-blue-800" onClick={() => addForExtraction(materialHolder)}>
