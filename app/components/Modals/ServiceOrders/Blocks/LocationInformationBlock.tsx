...
function LocationInformationBlock({ infoHolder, setInfoHolder }: LocationInformationBlockProps) {
	...
	return (
		<div className="flex w-full flex-col gap-y-2">
			<h1 className="w-full bg-primary/70  p-1 text-center font-medium text-primary-foreground">INFORMAÇÕES DE LOCALIZAÇÃO</h1>
...
export default LocationInformationBlock;
