...
function NewHomologation({ opportunity, session, closeModal, affectedQueryKey }: NewHomologationProps) {
	...
	async function requestHomologation({ info, files }: { info: THomologation; files: TFileHolder }) {
		...
		const insertFileReferencesResponse = await createManyFileReferences({
			info: links,
		});
	...
	return (
		<ResponsiveDialogDrawer
			menuTitle="NOVA HOMOLOGAÇÃO"
			menuDescription="Preencha os campos abaixo para criar uma nova homologação."
