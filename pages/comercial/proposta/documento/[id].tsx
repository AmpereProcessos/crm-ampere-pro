  ...
  return (
    <div className="relative flex w-full items-center justify-center bg-gray-50">
      ...
      <div className="fixed right-4 top-1/2 z-50 hidden -translate-y-1/2 flex-col gap-3 print:hidden lg:flex">
        <button className="group relative rounded-full bg-white p-3 shadow-lg transition-all hover:bg-gray-50" onClick={() => generatePDF()}>
        ...
        <button className="group relative rounded-full bg-white p-3 shadow-lg transition-all hover:bg-gray-50" onClick={() => window.print()}>
          <svg className="h-6 w-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
